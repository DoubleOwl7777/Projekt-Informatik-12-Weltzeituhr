...
public class projekt_Informatik {
	...
	while (true)
		...
		HH = hours.format(ZonedDateTime.now(ZoneId.of("Europe/London")));
        MM = minutes.format(ZonedDateTime.now(ZoneId.of("Europe/London")));
		
        eingabeFertig=1;}
		
		 if(locationInput.equals("Berlin")||locationInput.equals("Wien")||locationInput.equals("Paris")||locationInput.equals("Amsterdam")||locationInput.equals("Brüssel")||locationInput.equals("Bern")||locationInput.equals("Rom")||locationInput.equals("Warschau")||locationInput.equals("Kopenhagen")||locationInput.equals("Stockholm")||locationInput.equals("Oslo")||locationInput.equals("Belgrad")||locationInput.equals("Bratislava")||locationInput.equals("Budapest")||locationInput.equals("Ljubljana")||locationInput.equals("Zagreb")||locationInput.equals("Sarajevo")||locationInput.equals("Skopje")||locationInput.equals("Tirana")||locationInput.equals("Podgorica")||locationInput.equals("Valetta")||locationInput.equals("Andorra La Vella")||locationInput.equals("Luxembourg")||locationInput.equals("Vaduz")||locationInput.equals("Palma"))		//wenn der ort in der zeitzohne +1 liegt dann nimm die korrekte zeit dafür
		{DateTimeFormatter minutes = DateTimeFormatter.ofPattern("mm");
		DateTimeFormatter hours = DateTimeFormatter.ofPattern("HH");
        ...
        eingabeFertig=1;}
  		 ...
  		 if(locationInput.equals("Kiew")||locationInput.equals("Helsinki")||locationInput.equals("Tallinn")||locationInput.equals("Riga")||locationInput.equals("Vilnius")||locationInput.equals("Kischinau")||locationInput.equals("Bukarest")||locationInput.equals("Sofia")||locationInput.equals("Ankara")||locationInput.equals("Athen"))		//wenn der ort in der zeitzohne +2 liegt dann nimm die korrekte zeit dafür
		{DateTimeFormatter minutes = DateTimeFormatter.ofPattern("mm");
		DateTimeFormatter hours = DateTimeFormatter.ofPattern("HH");
        ...
        eingabeFertig=1;}
		 ...
		 if(locationInput.equals("Moskau")||locationInput.equals("Minsk"))		//wenn der ort in der zeitzohne +3 liegt dann nimm die korrekte zeit dafür
		{DateTimeFormatter minutes = DateTimeFormatter.ofPattern("mm");
		DateTimeFormatter hours = DateTimeFormatter.ofPattern("HH");
